# Quantum CoreOS Planning

This directory contains the planning and integration baseline for Quantum CoreOS.

- `ARCHITECTURE.md`: technical component boundaries and integration model
- `ROADMAP.md`: phased implementation plan
- `IMPLEMENTATION-STATUS.md`: current state of Quantum Runtime, Quantum Control and the CoreOS integration gate
- `PROJECT-BOUNDARIES.md`: independent repository ownership and build order
